...
public class WriteCSV {
  private WriteCSV() {
    //This constructor is empty, class is use only to write csv files given the database as parameter
  }
   ...
   * @param filename - String with name of file to be created and write information into.
   */
  ...
  /**
   * First string contain the name of the previous filename to be rename as newFilename, if it exist.
   * If newFilename exist before calling this function, we would deleted.
   * 
   * @param prevFilename - String with name of file to be change of names to newFilename, if it exist.
   * @param newFilename - String with name of file to be deleted if newFilename file exist and create a new one with prevFilename file information.
   */
