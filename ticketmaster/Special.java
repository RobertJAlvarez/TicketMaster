...
/**
 * Special is a class that extends the Event class containing, event id, name,
...
public class Special extends Event {
  /**
   * Constructor to create an Event with all parameters. It invokes the super
   * constructor.
   * 
  ...
  /**
   * Constructor to create an Event with no parameters. It invokes the super
   * constructor.
   */
  public Special() {
    super();
