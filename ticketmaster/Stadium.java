...
;
/**
 * Stadium is a class that extends the Venue class to be use in the Event class
 * 'to have a place to hold an event.'
 * 
...
public class Stadium extends Venue {
  /**
   * Constructor to create a venue by invoking the super constructor with all
   * parameters.
   * 
